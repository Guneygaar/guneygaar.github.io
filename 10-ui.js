...
.board-nav-btn:active { opacity: 1; }
.board-nav-btn:disabled { opacity: 0.2; pointer-events: none; }
...
#pcs-overlay.open .pcs-handle { opacity: 1; }
...
.pcs-subtitle-stage { font-weight: 600; }
.pcs-subtitle-sep {
  margin: 0 5px;
  opacity: 0.4;
}
