...
function _renderClientViewInner() {
  ...
  if (reqForm && !reqForm.dataset.init) {
    ...
    reqForm.innerHTML =
      '<div style="width:100%;max-width:390px;height:70vh;max-height:70vh;overflow:hidden;display:flex;flex-direction:column;background:#0a0a0f;border-top:1px solid rgba(255,255,255,0.12);">' +
        '<div style="flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:12px 18px;">' +
