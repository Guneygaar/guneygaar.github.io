...
export function StageStrip({ post, canMove }) {
  ...
  return (
    <div className="flex items-center gap-2.5 px-3 py-2.5 border-b border-divider-warm">
      ...
      {canMove && (
        <span className="inline-flex items-center gap-1.5 text-sm font-medium text-text-mid px-2.5 py-1.5 rounded-sm2 opacity-40 cursor-not-allowed" title="Stage move ships PR 2">
          <ArrowRight size={12} />
          <span>Move</span>
